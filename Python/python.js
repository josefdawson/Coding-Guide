const paragraphs = [document.getElementById('p1'), document.getElementById('p2'), document.getElementById('p3'), document.getElementById('p4'), document.getElementById('p5'), document.getElementById('p6'), document.getElementById('p7'), document.getElementById('p8'), document.getElementById('p9'), document.getElementById('p10'), document.getElementById('p11'), document.getElementById('p12'), document.getElementById('p13'), document.getElementById('p14'), document.getElementById('p15'), document.getElementById('p16'), document.getElementById('p17'), document.getElementById('p18'), document.getElementById('p19'), document.getElementById('p20'), document.getElementById('p21'), document.getElementById('p22'), document.getElementById('p23'), document.getElementById('p24'), document.getElementById('p25'), document.getElementById('p26'), document.getElementById('p27'), document.getElementById('p28'), document.getElementById('p29'), document.getElementById('p30')];
...
function unlockNext() {
    ...
    if (lastViewedIndex !== null && lastViewedIndex >= paragraphs.length - 1) {
        ...
        nextBtn.textContent = 'Next: JavaScript →';
...
async function initPyodide() {
    try {
        ...
        pyodideReady = true;
        outputLog.textContent = "Python ready!";
    } catch (err) {
        outputLog.textContent = "Error loading Python: " + err.message;
    }
}
...
if (runButton && codeTextarea && outputLog) {
    runButton.addEventListener('click', async () => {
        ...
        if (!pyodideReady) {
            outputLog.textContent = "Python is still loading, please wait...";
            return;
        }
...
nextBtn.addEventListener('click', () => {
    ...
    window.location.href = '../JavaScript/js.html';
});
