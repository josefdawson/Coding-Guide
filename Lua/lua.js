const scrabutton = document.getElementById('scratch');
const paragraphs = [document.getElementById('p1'), document.getElementById('p2'), document.getElementById('p3'), document.getElementById('p4'), document.getElementById('p5'), document.getElementById('p6'), document.getElementById('p7'), document.getElementById('p8'), document.getElementById('p9'), document.getElementById('p10'), document.getElementById('p11'), document.getElementById('p12'), document.getElementById('p13'), document.getElementById('p14'), document.getElementById('p15'), document.getElementById('p16'), document.getElementById('p17'), document.getElementById('p18'), document.getElementById('p19'), document.getElementById('p20'), document.getElementById('p21'), document.getElementById('p22'), document.getElementById('p23'), document.getElementById('p24')];
...
function unlockNext() {
    ...
    if (lastViewedIndex !== null && lastViewedIndex >= paragraphs.length - 1) {
        ...
        nextBtn.textContent = 'Next: Python →';
...
function editorFunction(onEditortf) {
    ...
    if (onEditortf === true) {
        ...
        scrabutton.style.display = 'block';
...
scrabutton.addEventListener('click', () => {
...
if (runButton && codeTextarea && outputLog) {
    runButton.addEventListener('click', () => {
        ...
        if (typeof fengari === 'undefined') {
            outputLog.textContent = "Error: Fengari failed to load. Check your internet connection.";
            return;
        }
        ...
        try {
            ...
            fengari.load(currentCode)();
            console.log = origLog;
            outputLog.textContent = captured.join("\n");
        } catch (err) {
